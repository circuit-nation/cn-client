            ...
            {items.map((item, idx) => (
                ...
                >
                    {hovered === idx && (
                        <motion.div
                            layoutId="hovered"
                            className="absolute inset-0 h-full w-full rounded-full bg-slate-700"
                        />
                    )}
...
export const NavbarButton = ({
    ...
    const variantStyles = {
        ...
        gradient:
            "bg-gradient-to-b from-cn-blue to-cn-blue-dark text-foreground shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
    };

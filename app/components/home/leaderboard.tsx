...
const f1Constructors = [
    { position: 1, name: "McLaren", points: 666, color: "bg-cn-orange" },
    { position: 2, name: "Ferrari", points: 652, color: "bg-cn-red" },
    { position: 3, name: "Red Bull Racing", points: 597, color: "bg-cn-blue-dark" },
    { position: 4, name: "Mercedes", points: 468, color: "bg-cn-teal" },
    { position: 5, name: "Aston Martin", points: 94, color: "bg-cn-green" },
];
...
const motoGpConstructors = [
    { position: 1, name: "Ducati", points: 876, color: "bg-cn-red" },
    { position: 2, name: "KTM", points: 327, color: "bg-cn-orange" },
    { position: 3, name: "Aprilia", points: 302, color: "bg-slate-700" },
    { position: 4, name: "Yamaha", points: 144, color: "bg-cn-blue" },
    { position: 5, name: "Honda", points: 68, color: "bg-cn-red" },
];

const PositionBadge = ({ position, variant }: { position: number; variant: "f1" | "motogp" }) => {
    const colors = {
        1: variant === "f1" ? "bg-cn-red" : "bg-cn-blue-dark",
        2: "bg-slate-400",
        3: "bg-cn-amber",
    };
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            <div className="p-2 rounded-lg bg-cn-red/60">
                                <Trophy className="w-5 h-5" />
                            </div>
                            <h3 className="font-serif text-2xl text-cn-red">Formula 1</h3>
                        </div>
                                ...
                                {f1Drivers.map((driver) => (
                                    <div key={driver.position} className="leaderboard-row">
                                        ...
                                        <div className="text-right">
                                            <span className="text-xl font-bold text-cn-red/80">{driver.points}</span>
                            ...
                            <TabsContent value="constructors" className="space-y-3">
                                {f1Constructors.map((team) => (
                                    <div key={team.position} className="leaderboard-row">
                                        ...
                                        <div className="text-right">
                                            <span className="text-xl font-bold text-cn-red/80">{team.points}</span>
                                            <span className="text-sm text-muted-foreground ml-1">pts</span>
                                        </div>
                                    </div>
                                ))}
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            <div className="p-2 rounded-lg bg-cn-blue-dark/60">
                                <Trophy className="w-5 h-5" />
                            </div>
                            <h3 className="font-serif text-2xl text-cn-blue-dark">MotoGP</h3>
                        </div>
                            ...
                            <TabsContent value="riders" className="space-y-3">
                                {motoGpRiders.map((rider) => (
                                    <div key={rider.position} className="leaderboard-row">
                                        ...
                                        <div className="text-right">
                                            <span className="text-xl font-bold text-cn-blue/80">{rider.points}</span>
                                            <span className="text-sm text-muted-foreground ml-1">pts</span>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <TabsContent value="constructors" className="space-y-3">
                                {motoGpConstructors.map((team) => (
                                    <div key={team.position} className="leaderboard-row">
                                        ...
                                        <div className="text-right">
                                            <span className="text-xl font-bold text-cn-blue/80">{team.points}</span>
                                            <span className="text-sm text-muted-foreground ml-1">pts</span>
                                        </div>
                                    </div>
                                ))}

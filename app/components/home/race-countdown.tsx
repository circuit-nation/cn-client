...
const CountdownUnit = ({ value, label, variant }: { value: number; label: string; variant: "f1" | "motogp" }) => (
    <div className={`flex flex-col items-center p-4 rounded-xl ${variant === "f1" ? "bg-cn-red/20" : "bg-cn-blue/20"}`}>
        <span className={`text-4xl md:text-5xl font-bold font-sans ${variant === "f1" ? "text-cn-red" : "text-cn-blue"}`}>
                        ...
                        <div className="glass-card rounded-2xl overflow-hidden glow-f1">
                            <div className="relative h-64 md:h-80">
                                ...
                                <div className="absolute bottom-4 left-6">
                                    <span className="bg-cn-red text-foreground px-3 py-1 rounded-full text-sm font-semibold">
                                        Formula 1
                                    </span>
                                </div>
                            </div>
                    ...
                    <TabsContent value="motogp" className="animate-fade-in">
                        <div className="glass-card rounded-2xl overflow-hidden glow-motogp">
                            <div className="relative h-64 md:h-80">
                                ...
                                <div className="absolute inset-0 bg-linear-to-t from-background via-background/50 to-transparent" />
                                <div className="absolute bottom-4 left-6">
                                    <span className="bg-cn-blue-dark text-foreground px-3 py-1 rounded-full text-sm font-semibold">
                                        MotoGP
                                    </span>
                                </div>
                            </div>
